...
class EgoTube(Tool):
    ...
    async def use(self, query: str, user_id: Optional[str] = None) -> str:
        ...
        yt_regex = r'https?://(?:www\.)?(?:youtube\.com/watch\?v=|youtu\.be/|youtube\.com/embed/)([\w-]+)'
...
class EgoCodeExec(Tool):
    ...
    def __init__(self, backend: Optional[LLMProvider] = None):
        super().__init__(
            name="EgoCodeExec",
    ...
    async def use(self, query: str, user_id: Optional[str] = None) -> str:
        ...
        try:
            ...
            try:
                ...
                return f"Error: Sandbox image {self.image_name} not found. Please ensure it is built."
