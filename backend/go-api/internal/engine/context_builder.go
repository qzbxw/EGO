...
func (cb *contextBuilder) build(ctx context.Context, user *models.User, session *models.ChatSession, logID int64, isRegen bool, newlyAttachedIDs []int64, query string, memoryEnabled bool) (*llmContext, error) {
	...
	// 4. Gather information about all files (new and historical) for the request.
	...
	// 5. Fetch the active plan for this session.
