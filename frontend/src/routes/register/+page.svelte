		...
		>
			...
			>
				...
				<form onsubmit={handleRegister} class="space-y-5" novalidate>
					...
					>
						<div
							class="inline-flex cursor-pointer select-none items-center justify-center gap-3 group"
							onclick={() => {
								accept = !accept;
						...
						>
							<div
								class="flex h-5 w-5 min-w-[1.25rem] items-center justify-center rounded-lg border-2 transition-all duration-300 ease-out group-hover:scale-110 group-active:scale-90 {accept
									? 'border-accent bg-accent text-white shadow-[0_0_10px_rgba(var(--color-accent-rgb),0.5)] rotate-0'
							...
							<span class="leading-relaxed opacity-80 transition-opacity group-hover:opacity-100"
								...
								<a
									href="/terms"
									target="_blank"
									class="font-bold hover:text-text-primary transition-colors hover:underline decoration-text-primary/30 underline-offset-2"
				...
				<!-- Social Login -->
				<div in:fly={{ y: 20, duration: 800, delay: 1100, easing: cubicOut }} class="transition-transform duration-300 hover:scale-[1.02] active:scale-[0.98]">
					<GoogleLogin />
				</div>
